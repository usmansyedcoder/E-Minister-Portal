      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Share your valuable suggestions for the development of Khyber
              Pakhtunkhwa
            </p>
            <div
              style={{
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group" style={{ marginTop: "5px" }}>
              ...
              <input
                ...
                name="subject"
                className="form-control"
                placeholder="Brief subject of suggestion"
            ...
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                transition: "all 0.3s ease",
                boxShadow: "0 4px 20px rgba(1, 65, 28, 0.4)",
                letterSpacing: "1px",
                marginTop: "10px",
              }}
              disabled={loading}
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 8px 35px rgba(1, 65, 28, 0.5)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
                e.currentTarget.style.boxShadow =
                  "0 4px 20px rgba(1, 65, 28, 0.4)";
              }}
            >
              {loading ? (
                <span
